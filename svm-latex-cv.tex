...
% Define a new environment for bulleted items in specific sections
...
%github
$if(github)$$if(fontawesome)$\faGithub \hspace{1 mm}$else$\emph{Github:}$endif$ $github$ \hspace{1 mm} $endif$  
%github
$if(twitter)$$if(fontawesome)$\faTwitter \hspace{1 mm}$else$\emph{Twitter:}$endif$ $twitter$ \hspace{1 mm} $endif$  
%website
